...
#ifndef _idaklu_JAX_idaklu_H_
#define _idaklu_JAX_idaklu_H_
...
#ifdef __CUDACC__
#define idaklu_JAX_INLINE_OR_DEVICE __host__ __device__
#else
#define idaklu_JAX_INLINE_OR_DEVICE inline
...
template <typename T>
idaklu_JAX_INLINE_OR_DEVICE void compute_eccentric_anomaly(const T& mean_anom, const T& ecc,
